...
function Side({ rotation = [0, 0, 0], bg = '#f0f0f0', children, index }) {
  ...
  const { nodes } = useGLTF('https://cdn.glitch.global/0664c9bb-42d1-4d9a-8003-ece58ab9d670/aobox-transformed.glb?v=1702233614770')
  ...
  return (
    <MeshPortalMaterial worldUnits={worldUnits} attach={`material-${index}`}>
      ...
      <mesh castShadow receiveShadow rotation={rotation} geometry={nodes.Cube.geometry}>
        ...
        <spotLight castShadow color={bg} intensity={2} position={[5, 5, 5]} angle={0.15} penumbra={1} shadow-normalBias={0.05} shadow-bias={0.0001} />
      </mesh>
      {/** The shape */}
